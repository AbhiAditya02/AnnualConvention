...
const SCHEDULE = {
    'Day 1 — 07 May': {
        ...
        events: [
            { title: 'Inaugural Address & Keynote', desc: 'Opening remarks followed by a keynote on the event.', tag: 'Keynote', color: 'blue' },
            ...
            { title: 'CTF Round 2 — Final Challenge', desc: 'Final Capture The Flag round featuring cybersecurity challenges for shortlisted participants.', tag: 'CTF Finals', color: 'maroon' },
            { title: 'Winner Announcement', desc: 'Announcement of winners.', tag: 'Closing', color: 'pink' },
        ]
    },
    ...
    'Day 2 — 08 May': {
        ...
        events: [
            { title: 'Welcome / Opening Speech', desc: 'Formal inauguration of the convention with an opening address', tag: 'Opening', color: 'green' },
            ...
            { title: 'Quiz', desc: 'Interactive quiz session for participants.', tag: 'Activity', color: 'green' },
            { title: 'Group Song', desc: 'Musical group performance by students as part of the cultural segment.', tag: 'Culture', color: 'maroon' },
            { title: 'Felicitation of 4th Year Students', desc: 'Recognition and presentation of mementos to 4th year students.', tag: 'Felicitation', color: 'pink' },
